...
const images = {
  ...
  offers: require('./camion_1.png'),
  services: require('./ser_1.png'),
  ...
  markerDestination: require('./markerDestination.png'),
  markerOrigin: require('./markerOrigin.png'),
  markerLocation: require('./markerLocation.png'),
