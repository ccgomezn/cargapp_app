        ...
        <MainContainer>
          ...
          <>
            ...
            <RowContainer>
              ...
              <NormalTitle>
                $
                {summary.data.service.price * 0.70}
              </NormalTitle>
            </RowContainer>
            <RowContainer>
              ...
              <NormalTitle>
                $
                {summary.data.service.statu_id !== 50 ? summary.data.service.price * 0.30 : 0}
              </NormalTitle>
            </RowContainer>
          </>
          <Line />
          ...
          <WrapperButton>
            {summary.data.service.statu_id === 19 && (
              <ButtonGradient press={() => this.imageDocument('Confimacion de cumplido', summary.data.service.id, documentConfirm)} content="Finalizar" disabled={false} />
            ) }
